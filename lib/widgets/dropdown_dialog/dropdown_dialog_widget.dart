...
class DropdownDialogWidget extends StatelessWidget {
  ...
  const DropdownDialogWidget({Key key, this.items, this.selectedValue, this.onChanged}) : super(key: key);


  @override
  Widget build(BuildContext context) {
    return _DropdownDialog(items: items, selectedValue: selectedValue, onChanged: onChanged);
  }
}